...
from dataset import bowl_18_dataset
import utils
...
def main():
    ...
    arg('--fold', type=float, help='fold', default=0)
    ...
    def make_loader(file_names, shuffle=False, transform=None, problem_type='binary'):
        return DataLoader(
            dataset = bowl_18_dataset(file_names, transform=transform, problem_type=problem_type),
            shuffle=shuffle,
